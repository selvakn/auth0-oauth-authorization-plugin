...
import cd.go.authorization.auth0.exceptions.NoSuchRequestHandlerException;
import cd.go.authorization.auth0.executors.*;
import cd.go.authorization.auth0.requests.*;
...
import static cd.go.authorization.auth0.Constants.PLUGIN_IDENTIFIER;

@Extension
public class Auth0Plugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(Auth0Plugin.class);
